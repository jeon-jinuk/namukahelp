...
public class BoardService {
    ...
    public void save(com.shop.dto.BoardDTO boardDTO) throws IOException {
        // 파일 첨부 여부에 따라 로직 분리
        if (boardDTO.getBoardFile().isEmpty()) {
            ...
            String savePath = "C:/image/" + storedFileName; // 4. C:/springboot_img/9802398403948_내사진.jpg
...
//            boardDTO.setBoardWriter(member.getMemberName());
            return boardDTO;
        } else {
            return null;
        }
...
//        System.out.println("boardEntities.isLast() = " + boardEntities.isLast()); // 마지막 페이지 여부
        ...
        Page<BoardDTO> boardDTOS = boardEntities.map(board -> new BoardDTO(board.getId(),  board.getBoardWriter(), board.getTitle(), board.getHit(), board.getCreatedTime(),board.getUpdatedTime()));
        return boardDTOS;
    }
