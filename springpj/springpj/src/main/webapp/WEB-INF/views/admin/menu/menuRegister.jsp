	...
	<div class="container-fluid">
		<div class="row">
				...
				<div class="position-sticky pt-3">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link" aria-current="page"
							href="/admin/branch/branchList">
								<span data-feather="home"></span> 지점 관리
						</a></li>
						...
						<li class="nav-item"><a class="nav-link" aria-current="page"
							href="/admin/study/studyList">
								<span data-feather="home"></span> 스터디 관리
						</a></li>
					...
					<h6
						...
						<span><a href="/logout">로그아웃</a></span> <a class="link-secondary"
							href="/logout" aria-label="Add a new report">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div class="container">
					<h2>메뉴추가</h2>
					<form action="/admin/menu/insert" method="post"
						enctype="multipart/form-data">
						<div class="form-group">
							<label for="id">메뉴번호:</label> <input type="text"
								class="form-control" id="id" placeholder="메뉴번호" name="id">
						</div>
						<div class="form-group">
							<label for="name">메뉴명:</label> <input type="text"
								class="form-control" id="name" placeholder="메뉴명" name="name">
						</div>
						<div class="form-group">
							<label for="intro">설명:</label> <input type="text"
								class="form-control" id="intro" placeholder="설명" name="intro">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="price">가격:</label> <input type="text"
								class="form-control" id="price" placeholder="가격" name="price">
						</div>
						<div class="form-group">
							<label for="menuType">메뉴타입:</label> <select name="menuType">
