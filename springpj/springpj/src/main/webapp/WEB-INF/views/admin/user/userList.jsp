		...
		<div class="row">
				...
				<div class="position-sticky pt-3">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link" aria-current="page"
							href="/admin/branch/branchList"> <span data-feather="home"></span>
								지점 관리
						</a></li>
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div
					...
					<ul class="find-role">
						<li><button type="button"
								onclick="location.href='/admin/user/userList'">전체</button></li>
						<li><button type="button"
								onclick="location.href='/admin/user/userList?role=user'">일반
								회원</button></li>
						<li><button type="button"
								onclick="location.href='/admin/user/userList?role=manager'">카페매니저</button></li>
					</ul>
					<form action="/admin/user/userList" method="get" class="search">
						<select name="field">
				...
				<div class="table-responsive">
					<form action="/admin/userdelete" method="post" id="userDeleteForm">
						<input type="button" onclick="deleteConfirm()" id="deleteUser"
							value="삭제">
						<table class="table table-striped table-sm">
							...
							<tbody>
								<c:forEach items="${userlist}" var="user">
									<fmt:formatDate value="${user.regdate}" pattern="yyyy-MM-dd" var="regdate"/>
									<tr>
										<td class="delete"><input class="form-check-input"
