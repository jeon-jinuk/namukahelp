	...
	<div class="container-fluid">
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div>
					<form action="/admin/branch/update" method="post" id="branchForm"
							...
							<div class="left">
								...
								<div class="form-group">
									<label for="sample6_address">주소</label> <input type="text"
										...
										value="${branch.addr}" placeholder="주소"> <input
								...
								<div class="form-group">
									<label for="phone">전화번호:</label> <input type="text"
										value="${branch.phone}" class="form-control" id="phone"
...
<script>
	...
	$("#${seat.x}${seat.y}").attr("checked", true);
	</c:forEach>
