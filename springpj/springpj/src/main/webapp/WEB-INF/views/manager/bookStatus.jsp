					...
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link " aria-current="page"
							href="/manager/currentStatus">
								<span data-feather="home"></span> 매장 현황
						</a></li>
						...
						<tbody>
							<c:forEach items="${bookList}" var="book">
								<tr>
									...
									<td>${book.bookDate }</td>
									<td><c:forEach items="${book.bookMenus}" var="menu">
                                        	<span>${menu.cafeMenu.menu.name}</span>
                                        </c:forEach></td>

									<td><c:forEach items="${book.bookseats}" var="seat">
